...
class TestListAllFilters():
    ...
    def test_list_all_filters_all_params(self):
        ...
        """
        # Set up mock
        url = self.preprocess_url(_base_url + '/v1/testString/zones/testString/filters')
        ...
        # Invoke method
        response = _service.list_all_filters(
            x_auth_user_token,
            crn,
            zone_identifier,
            headers={}
    ...
    def test_list_all_filters_value_error(self):
        ...
        for param in req_param_dict.keys():
            ...
            with pytest.raises(ValueError):
                _service.list_all_filters(**req_copy)
...
class TestCreateFilter():
    ...
    def test_create_filter_all_params(self):
        ...
        # Invoke method
        response = _service.create_filter(
            x_auth_user_token,
            crn,
            zone_identifier,
    ...
    def test_create_filter_value_error(self):
        ...
        for param in req_param_dict.keys():
            req_copy = {key:val if key is not param else None for (key,val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.create_filter(**req_copy)
...
class TestUpdateFilters():
    ...
    def test_update_filters_all_params(self):
        ...
        # Invoke method
        response = _service.update_filters(
            x_auth_user_token,
            crn,
            zone_identifier,
    ...
    def test_update_filters_value_error(self):
        ...
        for param in req_param_dict.keys():
            req_copy = {key:val if key is not param else None for (key,val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.update_filters(**req_copy)
...
class TestDeleteFilters():
    ...
    def test_delete_filters_all_params(self):
        ...
        # Invoke method
        response = _service.delete_filters(
            x_auth_user_token,
            crn,
            zone_identifier,
            id,
    ...
    def test_delete_filters_value_error(self):
        ...
        for param in req_param_dict.keys():
            req_copy = {key:val if key is not param else None for (key,val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.delete_filters(**req_copy)
...
class TestDeleteFilter():
    ...
    def test_delete_filter_all_params(self):
        ...
        """
        # Set up mock
        url = self.preprocess_url(_base_url + '/v1/testString/zones/testString/filters/testString')
        mock_response = '{"success": true, "errors": [["errors"]], "messages": [["messages"]], "result": {"id": "b7ff25282d394be7b945e23c7106ce8a"}}'
        responses.add(responses.DELETE,
                      url,
                      body=mock_response,
        ...
        # Invoke method
        response = _service.delete_filter(
            x_auth_user_token,
            crn,
            zone_identifier,
            filter_identifier,
    ...
    def test_delete_filter_value_error(self):
        ...
        for param in req_param_dict.keys():
            req_copy = {key:val if key is not param else None for (key,val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.delete_filter(**req_copy)
...
class TestUpdateFilter():
    ...
    def test_update_filter_all_params(self):
        ...
        # Invoke method
        response = _service.update_filter(
            x_auth_user_token,
            crn,
            zone_identifier,
            filter_identifier,
    ...
    def test_update_filter_value_error(self):
        ...
        for param in req_param_dict.keys():
            req_copy = {key:val if key is not param else None for (key,val) in req_param_dict.items()}
            with pytest.raises(ValueError):
                _service.update_filter(**req_copy)
