...
"""
Unit Tests for TransitGatewayApiV1
"""
...
import responses
import urllib
from ibm_cloud_networking_services.transit_gateway_api_v1 import *

version = 'testString'

_service = TransitGatewayApiV1(
...
class TestNewInstance:
    ...
    def test_new_instance(self):
        ...
        service = TransitGatewayApiV1.new_instance(
            version=version,
            service_name='TEST_SERVICE',
        )

        assert service is not None
        assert isinstance(service, TransitGatewayApiV1)
