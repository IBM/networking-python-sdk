...
class TestModel_TransitConnection:
    ...
    def test_transit_connection_serialization(self):
        ...
        transit_gateway_tunnel_model['prefix_filters'] = [transit_gateway_connection_prefix_filter_reference_model]
        transit_gateway_tunnel_model['prefix_filters_default'] = 'permit'
...
class TestModel_TransitGatewayTunnel:
    ...
    def test_transit_gateway_tunnel_serialization(self):
        ...
        transit_gateway_tunnel_model_json['prefix_filters'] = [transit_gateway_connection_prefix_filter_reference_model]
        transit_gateway_tunnel_model_json['prefix_filters_default'] = 'permit'
