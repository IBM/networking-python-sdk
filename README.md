...
# IBM Cloud Networking Services Python SDK Version 0.3.2
...
```bash
pip install --upgrade "ibm-cloud-networking-services==0.3.2"
```

or

```bash
easy_install --upgrade "ibm-cloud-networking-servies==0.3.2"
```
