...
# IBM Cloud Networking Services Python SDK Version 0.32.0
...
```bash
pip install --upgrade "ibm-cloud-networking-services==0.32.0"
```

or

```bash
easy_install --upgrade "ibm-cloud-networking-servies==0.32.0"
```
