...
# IBM Cloud Networking Services Python SDK Version 0.17.1
...
```bash
pip install --upgrade "ibm-cloud-networking-services==0.17.1"
```

or

```bash
easy_install --upgrade "ibm-cloud-networking-servies==0.17.1"
```
