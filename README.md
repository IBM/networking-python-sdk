...
# IBM Cloud Networking Services Python SDK Version 0.34.0
...
```bash
pip install --upgrade "ibm-cloud-networking-services==0.34.0"
```

or

```bash
easy_install --upgrade "ibm-cloud-networking-servies==0.34.0"
```
