...
class ListResourceRecords():
    ...
    def __init__(self, resource_records: List['ResourceRecord'], offset: int, limit: int, total_count: int, first: 'FirstHref', *, next: 'NextHref' = None) -> None:
        """
...
class ResourceRecord():
    ...
    def __init__(self, *, id: str = None, created_on: datetime = None, modified_on: datetime = None, name: str = None, type: str = None, ttl: int = None, rdata: object = None, service: str = None, protocol: str = None) -> None:
        """
...
class ResourceRecordInputRdataRdataTxtRecord(ResourceRecordInputRdata):
    ...
    :attr str txtdata: Human readable text.
    """

    def __init__(self, txtdata: str) -> None:
        """
        Initialize a ResourceRecordInputRdataRdataTxtRecord object.

        :param str txtdata: Human readable text.
        """
        # pylint: disable=super-init-not-called
    ...
    def from_dict(cls, _dict: Dict) -> 'ResourceRecordInputRdataRdataTxtRecord':
        ...
        args = {}
        if 'txtdata' in _dict:
            args['txtdata'] = _dict.get('txtdata')
        else:
            raise ValueError('Required property \'txtdata\' not present in ResourceRecordInputRdataRdataTxtRecord JSON')
        return cls(**args)
    ...
    def to_dict(self) -> Dict:
        """Return a json dictionary representing this model."""
        _dict = {}
        if hasattr(self, 'txtdata') and self.txtdata is not None:
            _dict['txtdata'] = self.txtdata
        return _dict
...
class ResourceRecordUpdateInputRdataRdataTxtRecord(ResourceRecordUpdateInputRdata):
    ...
    def from_dict(cls, _dict: Dict) -> 'ResourceRecordUpdateInputRdataRdataTxtRecord':
        ...
        if 'txtdata' in _dict:
            ...
            raise ValueError('Required property \'txtdata\' not present in ResourceRecordUpdateInputRdataRdataTxtRecord JSON')
        return cls(**args)
