...
class ProviderGatewayCollection:
    ...
    def __init__(
        ...
        *,
        next: 'ProviderGatewayCollectionNext' = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'ProviderGatewayCollection':
        ...
        if 'gateways' in _dict:
            args['gateways'] = [ProviderGateway.from_dict(v) for v in _dict.get('gateways')]
        else:
...
class ProviderPortCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'ProviderPortCollection':
        ...
        if 'ports' in _dict:
            args['ports'] = [ProviderPort.from_dict(v) for v in _dict.get('ports')]
        return cls(**args)
...
class ProviderGatewayChangeRequestProviderGatewayUpdateAttributes(ProviderGatewayChangeRequest):
    ...
    def __init__(
        self,
        type: str,
        updates: List['ProviderGatewayUpdateAttributesUpdatesItem'],
    ) -> None:
        """
...
class ProviderGatewaysPager:
    """
    ProviderGatewaysPager can be used to simplify the use of the "list_provider_gateways" method.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a ProviderGatewaysPager object.
        :param int limit: (optional) The number of resources to return on a page.
        """
        self._has_next = True
        self._client = client
    ...
    def get_next(self) -> List[dict]:
        ...
        :return: A List[dict], where each element is a dict that represents an instance of ProviderGateway.
        :rtype: List[dict]
        """
        if not self.has_next():
            raise StopIteration(message='No more results available')

        result = self._client.list_provider_gateways(
            limit=self._limit,
...
class ProviderPortsPager:
    """
    ProviderPortsPager can be used to simplify the use of the "list_provider_ports" method.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a ProviderPortsPager object.
        :param int limit: (optional) The number of resources to return on a page.
        """
        self._has_next = True
        self._client = client
    ...
    def get_next(self) -> List[dict]:
        """
        Returns the next page of results.
        :return: A List[dict], where each element is a dict that represents an instance of ProviderPort.
        :rtype: List[dict]
        """
        if not self.has_next():
            raise StopIteration(message='No more results available')

        result = self._client.list_provider_ports(
            limit=self._limit,
            start=self._page_context.get('next'),
        ).get_result()
