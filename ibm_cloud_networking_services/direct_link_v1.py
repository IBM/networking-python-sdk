...
class DirectLinkV1(BaseService):
    ...
    def set_gateway_macsec(
        ...
        **kwargs,
        ...
        :param str id: Direct Link gateway identifier.
        :param bool active: Determines if the MACsec feature will initially be
               active (true) or inactive (false) for a direct link.
        ...
        :param str security_policy: Determines how packets without MACsec headers
               are handled.
               - `must_secure` - Packets without MACsec headers are dropped. Use this
               policy to prefer security over network availability.
               - `should_secure` - Packets without MACsec headers are allowed. Use this
               policy to prefer network availability over security.
    ...
    def create_gateway_macsec_cak(
        ...
        **kwargs,
        ...
        :param str id: Direct Link gateway identifier.
        :param GatewayMacsecCakKeyReference key:
...
class AuthenticationKeyIdentity:
    ...
    def __init__(
        ...
        msg = "Cannot instantiate base class. Instead, instantiate one of the defined subclasses: {0}".format(
            ", ".join(['AuthenticationKeyIdentityKeyProtectAuthenticationKeyIdentity', 'AuthenticationKeyIdentityHpcsAuthenticationKeyIdentity', 'AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity'])
        )
        raise Exception(msg)
...
class AuthenticationKeyReference:
    ...
    def __init__(
        ...
        """
        msg = "Cannot instantiate base class. Instead, instantiate one of the defined subclasses: {0}".format(
            ", ".join(['AuthenticationKeyReferenceHpcsAuthenticationKeyReference', 'AuthenticationKeyReferenceKeyProtectAuthenticationKeyReference', 'AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference'])
        )
        raise Exception(msg)
...
class CrossConnectRouter:
    ...
    :param List[str] capabilities: (optional) List of capabilities for this router.
          ...
          capability. Multiple `MacsecCapability` values can be listed.
    ...
    def __init__(
        ...
        *,
        ...
        :param List[str] capabilities: (optional) List of capabilities for this
               ...
               with that capability. Multiple `MacsecCapability` values can be listed.
        :param str router_name: (optional) The name of the Router.
...
class GatewayMacsec:
    ...
    :param bool active: Indicates if the MACsec feature is currently active (true)
          or inactive (false) for a direct link.
    ...
    :param str security_policy: Determines how packets without MACsec headers are
          handled.
          - `must_secure` - Packets without MACsec headers are dropped. Use this policy to
          prefer security over network availability.
          - `should_secure` - Packets without MACsec headers are allowed. Use this policy
          to prefer network availability over security.
    ...
    def __init__(
        ...
        :param bool active: Indicates if the MACsec feature is currently active
               (true) or inactive (false) for a direct link.
        :param str cipher_suite: The cipher suite used in generating the security
               association key (SAK).
    ...
    class SecurityPolicyEnum(str, Enum):
        ...
        - `must_secure` - Packets without MACsec headers are dropped. Use this policy to
        prefer security over network availability.
        - `should_secure` - Packets without MACsec headers are allowed. Use this policy to
        prefer network availability over security.
        """
...
class GatewayMacsecCak:
    ...
    :param GatewayMacsecCakActiveDelta active_delta: (optional) This field will be
          present when the `status` of the MACsec CAK is `rotating` or `inactive`. It
          might be present when the CAK `status` is `failed`.
    ...
    :param str status: Current status of the CAK.
          ...
          not currently used to secure the MACsec session. The CAK might enter `rotating`
          status, and ultimately the `active` status, if it is found to be used to secure
          the MACsec session. The CAK might never leave this status on its own (e.g. if
    ...
    def __init__(
        ...
        *,
        ...
        :param str status: Current status of the CAK.
               ...
               is not currently used to secure the MACsec session. The CAK might enter
               `rotating` status, and ultimately the `active` status, if it is found to be
               used to secure the MACsec session. The CAK might never leave this status on
        ...
        :param GatewayMacsecCakActiveDelta active_delta: (optional) This field will
               ...
               It might be present when the CAK `status` is `failed`.
    ...
    class StatusEnum(str, Enum):
        ...
        currently used to secure the MACsec session. The CAK might enter `rotating`
        status, and ultimately the `active` status, if it is found to be used to secure
        the MACsec session. The CAK might never leave this status on its own (e.g. if
        there is a key/key name mismatch). You are allowed to patch the CAK in this state
        to start the rotation procedure again.
        Status `failed` is returned when the CAK cannot be configured. To recover, first
        resolve any issues with your HPCS key, then patch this CAK with the same or new
        key. Alternatively, you can delete this CAK if used for the `fallback` session.
        """
...
class GatewayMacsecCakActiveDelta:
    ...
    `inactive`. It might be present when the CAK `status` is `failed`.
...
class GatewayMacsecCakKeyReference:
    """
    ...
    def __init__(
        ...
        """
        Initialize a GatewayMacsecCakKeyReference object.

        """
        msg = "Cannot instantiate base class. Instead, instantiate one of the defined subclasses: {0}".format(
            ", ".join(['GatewayMacsecCakKeyReferenceHpcsCakKeyReference', 'GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference'])
        )
        raise Exception(msg)
...
class GatewayMacsecCakPatch:
    ...
    :param GatewayMacsecCakKeyReference key: (optional)
    ...
    def __init__(
        self,
        *,
        key: Optional['GatewayMacsecCakKeyReference'] = None,
...
class GatewayMacsecPatch:
    """
    Patch fields for MACsec configuration of a direct link.

    :param bool active: (optional) Sets the MACsec feature to be active (true) or
          inactive (false) for a direct link.
...
class GatewayMacsecPrototype:
    ...
    :param bool active: Determines if the MACsec feature will initially be active
          (true) or inactive (false) for a direct link.
    :param List[GatewayMacsecCakPrototype] caks: List of all connectivity
...
class GatewayMacsecStatusReason:
    ...
    :param str code: A reason code for the status:
          ...
          direct link. Refer to the `status` of the CAKs associated with the MACsec
    ...
    def __init__(
        ...
        *,
        ...
        :param str code: A reason code for the status:
               ...
               on the direct link. Refer to the `status` of the CAKs associated with the
    ...
    class CodeEnum(str, Enum):
        ...
        link. Refer to the `status` of the CAKs associated with the MACsec configuration
...
class LocationOutput:
    ...
    :param bool macsec_enabled: (optional) Indicate whether location supports
          MACsec.  Only returned for direct link type=dedicated locations.
...
class OfferingSpeed:
    ...
    :param bool macsec_enabled: (optional) Indicate whether speed supports MACsec.
          Only returned for gateway type=dedicated speeds.
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param bool macsec_enabled: (optional) Indicate whether speed supports
               MACsec.  Only returned for gateway type=dedicated speeds.
        """
        self.capabilities = capabilities
...
class AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity(AuthenticationKeyIdentity):
    """
    A [Secrets Manager Arbitrary
    Secret](https://cloud.ibm.com/docs/secrets-manager?topic=secrets-manager-getting-started).

    :param str crn: The CRN of the secret.
    """
    ...
    def __init__(
        ...
        """
        Initialize a AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity':
        """Initialize a AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity object from a json dictionary."""
        args = {}
        if (crn := _dict.get('crn')) is not None:
            args['crn'] = crn
        else:
            raise ValueError('Required property \'crn\' not present in AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'AuthenticationKeyIdentitySecretsManagerAuthenticationKeyIdentity') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference(AuthenticationKeyReference):
    """
    ...
    def __init__(
        ...
        """
        Initialize a AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference':
        """Initialize a AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference object from a json dictionary."""
        args = {}
        if (crn := _dict.get('crn')) is not None:
            args['crn'] = crn
        else:
            raise ValueError('Required property \'crn\' not present in AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'AuthenticationKeyReferenceSecretsManagerAuthenticationKeyReference') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class GatewayMacsecCakKeyReferenceHpcsCakKeyReference(GatewayMacsecCakKeyReference):
    """
    A reference to a [Hyper Protect Crypto Service Standard
    Key](https://cloud.ibm.com/docs/hs-crypto?topic=hs-crypto-get-started).
    ...
    def __init__(
        ...
        """
        Initialize a GatewayMacsecCakKeyReferenceHpcsCakKeyReference object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'GatewayMacsecCakKeyReferenceHpcsCakKeyReference':
        """Initialize a GatewayMacsecCakKeyReferenceHpcsCakKeyReference object from a json dictionary."""
        args = {}
        if (crn := _dict.get('crn')) is not None:
            args['crn'] = crn
        else:
            raise ValueError('Required property \'crn\' not present in GatewayMacsecCakKeyReferenceHpcsCakKeyReference JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this GatewayMacsecCakKeyReferenceHpcsCakKeyReference object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'GatewayMacsecCakKeyReferenceHpcsCakKeyReference') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'GatewayMacsecCakKeyReferenceHpcsCakKeyReference') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other


class GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference(GatewayMacsecCakKeyReference):
    """
    A reference to a [Secrets Manager Arbitrary
    Secret](https://cloud.ibm.com/docs/secrets-manager?topic=secrets-manager-getting-started).
    ...
    def __init__(
        ...
        """
        Initialize a GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference':
        """Initialize a GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference object from a json dictionary."""
        args = {}
        if (crn := _dict.get('crn')) is not None:
            args['crn'] = crn
        else:
            raise ValueError('Required property \'crn\' not present in GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'GatewayMacsecCakKeyReferenceSecretsManagerCakKeyReference') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
