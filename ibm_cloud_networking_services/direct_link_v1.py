...
class AsPrependCollection:
    ...
    def __init__(
        self,
        *,
        as_prepends: List['AsPrependEntry'] = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'AsPrependCollection':
        ...
        if 'as_prepends' in _dict:
            args['as_prepends'] = [AsPrependEntry.from_dict(v) for v in _dict.get('as_prepends')]
        return cls(**args)
...
class CrossAccountGatewayPort:
    ...
    def __init__(
        ...
        """
        Initialize a CrossAccountGatewayPort object.
    ...
    def from_dict(cls, _dict: Dict) -> 'CrossAccountGatewayPort':
        """Initialize a CrossAccountGatewayPort object from a json dictionary."""
        args = {}
        if 'id' in _dict:
            args['id'] = _dict.get('id')
        else:
            raise ValueError('Required property \'id\' not present in CrossAccountGatewayPort JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this CrossAccountGatewayPort object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'CrossAccountGatewayPort') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'CrossAccountGatewayPort') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ExportRouteFilterCollection:
    ...
    :attr List[RouteFilter] export_route_filters: Array of export route filters.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'ExportRouteFilterCollection':
        ...
        args = {}
        if 'export_route_filters' in _dict:
            args['export_route_filters'] = [RouteFilter.from_dict(v) for v in _dict.get('export_route_filters')]
        else:
...
class Gateway:
    ...
    :attr bool cross_account: Indicates whether this gateway is cross account
          gateway.
    ...
    :attr str customer_name: (optional) Customer name.  Only set for type=dedicated
          gateways.
    :attr str default_export_route_filter: The default directional route filter
          action that applies to routes that do not match any directional route filters.
    :attr str default_import_route_filter: The default directional route filter
          action that applies to routes that do not match any directional route filters.
    ...
    :attr str type: Offering type. The list of enumerated values for this property
          ...
          unexpected values.
    :attr int vlan: (optional) VLAN configured for this gateway. If there is no vlan
          configured for the gateway, the vlan will be absent. This property will also be
          absent if this gateway's `crn` is in another account.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'Gateway':
        ...
        args = {}
        if 'as_prepends' in _dict:
            args['as_prepends'] = [AsPrepend.from_dict(v) for v in _dict.get('as_prepends')]
        ...
        if 'cross_account' in _dict:
            args['cross_account'] = _dict.get('cross_account')
        else:
        ...
        if 'default_export_route_filter' in _dict:
            args['default_export_route_filter'] = _dict.get('default_export_route_filter')
        else:
            raise ValueError('Required property \'default_export_route_filter\' not present in Gateway JSON')
        if 'default_import_route_filter' in _dict:
            args['default_import_route_filter'] = _dict.get('default_import_route_filter')
        else:
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'macsec_config') and self.macsec_config is not None:
            if isinstance(self.macsec_config, dict):
                _dict['macsec_config'] = self.macsec_config
            else:
...
class GatewayBfdConfig:
    ...
    def __init__(
        ...
        *,
        bfd_status: str = None,
        bfd_status_updated_at: datetime = None,
    ) -> None:
        """
...
class GatewayCollection:
    ...
    :attr List[GatewayCollectionGatewaysItem] gateways: Collection of Direct Link
          gateways.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'GatewayCollection':
        ...
        if 'gateways' in _dict:
            args['gateways'] = _dict.get('gateways')
        else:
...
class GatewayMacsecConfig:
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'active_cak') and self.active_cak is not None:
            if isinstance(self.active_cak, dict):
                _dict['active_cak'] = self.active_cak
            else:
        ...
        if hasattr(self, 'fallback_cak') and self.fallback_cak is not None:
            if isinstance(self.fallback_cak, dict):
                _dict['fallback_cak'] = self.fallback_cak
            else:
        ...
        if hasattr(self, 'primary_cak') and self.primary_cak is not None:
            if isinstance(self.primary_cak, dict):
                _dict['primary_cak'] = self.primary_cak
            else:
...
class GatewayPatchTemplate:
    ...
    :attr GatewayPatchTemplateAuthenticationKey authentication_key: (optional) The
          identity of the standard key to use for BGP MD5 authentication key.
          The key material that you provide must be base64 encoded and original string
          must be maximum 126 ASCII characters in length.
          To clear the optional `authentication_key` field patch its crn to `""`.
    :attr GatewayBfdPatchTemplate bfd_config: (optional) BFD configuration
          information.
    :attr int bgp_asn: (optional) The autonomous system number (ASN) of Border
    ...
    :attr str connection_mode: (optional) Type of services this Gateway is attached
          ...
          list of enumerated values for this property may expand in the future. Code and
          processes using this field  must tolerate unexpected values.
    :attr str default_export_route_filter: (optional) The default directional route
          filter action that applies to routes that do not match any directional route
          filters.
    :attr str default_import_route_filter: (optional) The default directional route
          filter action that applies to routes that do not match any directional route
          filters.
    :attr bool global_: (optional) Gateways with global routing (`true`) can connect
          to networks outside of their associated region.
    :attr str loa_reject_reason: (optional) Use this field during LOA rejection to
          provide the reason for the rejection.
          Only allowed for type=dedicated gateways.
    :attr GatewayMacsecConfigPatchTemplate macsec_config: (optional) MACsec
          configuration information.  When patching any macsec_config fields, no other
          fields may be specified in the patch request.  Contact IBM support for access to
          MACsec.
          A MACsec config cannot be added to a gateway created without MACsec.
    :attr bool metered: (optional) Metered billing option.  When `true` gateway
    ...
    :attr str name: (optional) The unique user-defined name for this gateway.
    :attr str operational_status: (optional) Gateway operational status.
    ...
    :attr str patch_panel_completion_notice: (optional) Gateway patch panel complete
          notification from implementation team.
    :attr int speed_mbps: (optional) Gateway speed in megabits per second.
    :attr int vlan: (optional) The VLAN to configure for this gateway.
    ...
    def from_dict(cls, _dict: Dict) -> 'GatewayPatchTemplate':
        ...
        args = {}
        if 'authentication_key' in _dict:
            args['authentication_key'] = GatewayPatchTemplateAuthenticationKey.from_dict(_dict.get('authentication_key'))
        if 'bfd_config' in _dict:
            args['bfd_config'] = GatewayBfdPatchTemplate.from_dict(_dict.get('bfd_config'))
        if 'bgp_asn' in _dict:
            args['bgp_asn'] = _dict.get('bgp_asn')
        if 'bgp_cer_cidr' in _dict:
            args['bgp_cer_cidr'] = _dict.get('bgp_cer_cidr')
        ...
        if 'global' in _dict:
            args['global_'] = _dict.get('global')
        if 'loa_reject_reason' in _dict:
            args['loa_reject_reason'] = _dict.get('loa_reject_reason')
        if 'macsec_config' in _dict:
            args['macsec_config'] = GatewayMacsecConfigPatchTemplate.from_dict(_dict.get('macsec_config'))
        if 'metered' in _dict:
            args['metered'] = _dict.get('metered')
        if 'name' in _dict:
            args['name'] = _dict.get('name')
...
class GatewayStatisticCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'GatewayStatisticCollection':
        ...
        if 'statistics' in _dict:
            args['statistics'] = [GatewayStatistic.from_dict(v) for v in _dict.get('statistics')]
        else:
...
class GatewayStatusCollection:
    ...
    def __init__(
        self,
        *,
        status: List['GatewayStatus'] = None,
    ) -> None:
        """
...
class GatewayTemplate:
    ...
    :attr str default_import_route_filter: (optional) The default directional route
          filter action that applies to routes that do not match any directional route
          filters.
    :attr List[GatewayTemplateRouteFilter] export_route_filters: (optional) Array of
          directional route filters for a Direct Link gateway. When creating a gateway or
          replacing existing route filters, the order of the items in the array will set
          the ordering of the list of route filters.
    :attr bool global_: Gateways with global routing (`true`) can connect to
          networks outside their associated region.
    :attr List[GatewayTemplateRouteFilter] import_route_filters: (optional) Array of
          directional route filters for a Direct Link gateway. When creating a gateway or
          replacing existing route filters, the order of the items in the array will set
          the ordering of the list of route filters.
    :attr bool metered: Metered billing option.  When `true` gateway usage is billed
...
class GatewayTemplateRouteFilter:
    ...
    :attr str action: Determines whether routes that match the prefix-set will be
          allowed (permit) or rejected (deny) through the filter.
    :attr int ge: (optional) The minimum matching length of the prefix-set (mnemonic
          for greater than or equal to).
    :attr int le: (optional) The maximum matching length of the prefix-set (mnemonic
          for less than or equal to).
    :attr str prefix: IP prefix representing an address and mask length of the
          prefix-set.
    """
...
class GatewayVirtualConnectionCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'GatewayVirtualConnectionCollection':
        ...
        if 'virtual_connections' in _dict:
            args['virtual_connections'] = [GatewayVirtualConnection.from_dict(v) for v in _dict.get('virtual_connections')]
        else:
...
class ImportRouteFilterCollection:
    ...
    :attr List[RouteFilter] import_route_filters: Array of import route filters.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'ImportRouteFilterCollection':
        ...
        args = {}
        if 'import_route_filters' in _dict:
            args['import_route_filters'] = [RouteFilter.from_dict(v) for v in _dict.get('import_route_filters')]
        else:
...
class LocationCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'LocationCollection':
        ...
        if 'locations' in _dict:
            args['locations'] = [LocationOutput.from_dict(v) for v in _dict.get('locations')]
        else:
...
class LocationCrossConnectRouterCollection:
    ...
    def __init__(
        self,
        *,
        cross_connect_routers: List['CrossConnectRouter'] = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'LocationCrossConnectRouterCollection':
        ...
        if 'cross_connect_routers' in _dict:
            args['cross_connect_routers'] = [CrossConnectRouter.from_dict(v) for v in _dict.get('cross_connect_routers')]
        return cls(**args)
...
class OfferingSpeedCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'OfferingSpeedCollection':
        ...
        args = {}
        if 'speeds' in _dict:
            args['speeds'] = [OfferingSpeed.from_dict(v) for v in _dict.get('speeds')]
        else:
...
class PortCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'PortCollection':
        ...
        if 'ports' in _dict:
            args['ports'] = [Port.from_dict(v) for v in _dict.get('ports')]
        return cls(**args)
...
class RouteFilter:
    ...
    :attr str action: Determines whether routes that match the prefix-set will be
          allowed (permit) or rejected (deny) through the filter.
    :attr str before: (optional) Identifier of the next route filter considered if a
          route does not match the current filter. This property builds the ordering among
          route filters and follows semantics:
          ...
          created filter.
    :attr datetime created_at: The date and time the route filter was created in ISO
          8601 format.
    :attr int ge: (optional) The minimum matching length of the prefix-set (mnemonic
          for greater than or equal to).
    :attr str id: The identifier of a route filter.
    :attr int le: (optional) The maximum matching length of the prefix-set (mnemonic
          for less than or equal to).
    :attr str prefix: IP prefix representing an address and mask length of the
          prefix-set.
    :attr datetime updated_at: The date and time the route filter was last updated.
    """
...
class RouteReport:
    ...
    def from_dict(cls, _dict: Dict) -> 'RouteReport':
        ...
        if 'gateway_routes' in _dict:
            args['gateway_routes'] = [RouteReportRoute.from_dict(v) for v in _dict.get('gateway_routes')]
        else:
        ...
        if 'on_prem_routes' in _dict:
            args['on_prem_routes'] = [RouteReportOnPremRoute.from_dict(v) for v in _dict.get('on_prem_routes')]
        else:
        ...
        if 'virtual_connection_routes' in _dict:
            args['virtual_connection_routes'] = [RouteReportConnection.from_dict(v) for v in _dict.get('virtual_connection_routes')]
        else:
...
class RouteReportConnection:
    ...
    def __init__(
        ...
        *,
        ...
        virtual_connection_type: str = None,
    ) -> None:
        """
...
class UpdateRouteFilterTemplate:
    ...
    :attr str action: (optional) Determines whether routes that match the prefix-set
          will be allowed (permit) or rejected (deny) through the filter.
    :attr str before: (optional) Identifier of the next route filter considered if a
          route does not match the current filter. This property builds the ordering among
          route filters and follows semantics:
          - When before is an identifier of a route filter that exists and is in the same
    ...
    :attr str prefix: (optional) IP prefix representing an address and mask length
          of the prefix-set.
    """
...
class GatewayCollectionGatewaysItemCrossAccountGateway(GatewayCollectionGatewaysItem):
    ...
    :attr str operational_status: Gateway operational status. The list of enumerated
          values for this property may expand in the future. Code and processes using this
          field  must tolerate unexpected values.
    :attr CrossAccountGatewayPort port: (optional) gateway port for type=connect
          gateways.
    :attr int speed_mbps: Gateway speed in megabits per second.
    :attr str type: Offering type. The list of enumerated values for this property
          may expand in the future. Code and processes using this field  must tolerate
    ...
    def __init__(
        ...
        *,
        ...
        link_status: str = None,
        link_status_updated_at: datetime = None,
        port: 'CrossAccountGatewayPort' = None,
    ) -> None:
        """
        ...
        :param datetime link_status_updated_at: (optional) Date and time link
               status was updated.
        :param CrossAccountGatewayPort port: (optional) gateway port for
    ...
    def from_dict(cls, _dict: Dict) -> 'GatewayCollectionGatewaysItemCrossAccountGateway':
        ...
        if 'port' in _dict:
            args['port'] = CrossAccountGatewayPort.from_dict(_dict.get('port'))
        if 'speed_mbps' in _dict:
            args['speed_mbps'] = _dict.get('speed_mbps')
        else:
...
class GatewayTemplateGatewayTypeConnectTemplate(GatewayTemplate):
    ...
    def from_dict(cls, _dict: Dict) -> 'GatewayTemplateGatewayTypeConnectTemplate':
        ...
        args = {}
        if 'as_prepends' in _dict:
            args['as_prepends'] = [AsPrependTemplate.from_dict(v) for v in _dict.get('as_prepends')]
        if 'authentication_key' in _dict:
        ...
        if 'default_import_route_filter' in _dict:
            args['default_import_route_filter'] = _dict.get('default_import_route_filter')
        if 'export_route_filters' in _dict:
            args['export_route_filters'] = [GatewayTemplateRouteFilter.from_dict(v) for v in _dict.get('export_route_filters')]
        if 'global' in _dict:
            args['global_'] = _dict.get('global')
        else:
            raise ValueError('Required property \'global\' not present in GatewayTemplateGatewayTypeConnectTemplate JSON')
        if 'import_route_filters' in _dict:
            args['import_route_filters'] = [GatewayTemplateRouteFilter.from_dict(v) for v in _dict.get('import_route_filters')]
        if 'metered' in _dict:
            args['metered'] = _dict.get('metered')
        else:
...
class GatewayTemplateGatewayTypeDedicatedTemplate(GatewayTemplate):
    ...
    def __init__(
        ...
        *,
        ...
        patch_panel_completion_notice: str = None,
        resource_group: 'ResourceGroupIdentity' = None,
        macsec_config: 'GatewayMacsecConfigTemplate' = None,
        vlan: int = None,
    ) -> None:
        """
