...
class DnsResourceRecordsV1(BaseService):
    """The DNS Resource Records V1 service."""

    DEFAULT_SERVICE_URL = 'https://api.dns-svcs.cloud.ibm.com/v1'
    DEFAULT_SERVICE_NAME = 'dns_resource_records'

    @classmethod
    def new_instance(cls,
                     service_name: str = DEFAULT_SERVICE_NAME,
                    ) -> 'DnsResourceRecordsV1':
        """
        Return a new client for the DNS Resource Records service using the
    ...
    def __init__(self,
        ...
        """
        Construct a new client for the DNS Resource Records service.
