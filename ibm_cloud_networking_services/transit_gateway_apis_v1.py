...
class RedundancyGroup:
    ...
    :attr datetime created_at: The date and time that this redundancy group was
          created.
    :attr str id: The unique identifier for this redundancy group.
    :attr str name: The redundancy group name.
    :attr datetime updated_at: (optional) The date and time that this redundancy
...
class RedundancyGroupCollection:
    ...
    :attr List[RedundancyGroup] redundancy_groups: Collection of redundancy groups.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'RedundancyGroupCollection':
        ...
        args = {}
        if 'redundancy_groups' in _dict:
            args['redundancy_groups'] = [RedundancyGroup.from_dict(v) for v in _dict.get('redundancy_groups')]
        else:
...
class RedundancyGroupPatch:
    ...
    :attr str name: (optional) The new name for the redundancy group.
    """
...
class RouteReportConnection:
    ...
    :attr List[RouteReportConnectionBgp] bgps: Array of connection's bgps.
    :attr str id: (optional) connection ID.
    :attr str name: (optional) connection name.
    :attr List[RouteReportConnectionRoute] routes: Array of connection's routes.
...
class RouteReportConnectionBgp:
    ...
    :attr bool is_used: Indicates whether current route is used or not.
...
class RouteReportOverlappingRouteGroup:
    ...
    :attr List[RouteReportOverlappingRoute] routes: Array of overlapping
...
class TSLocalLocation:
    ...
    :attr List[str] supported_connection_types: Array of supported connection types.
...
class TransitConnection:
    ...
    :attr str cidr: (optional) network_type `vpn_gateway` and `dynamic_route_server`
          connections use `cidr` to specify the CIDR to use for the `VPN gateway / Dynamic
...
class TransitGateway:
    ...
    :attr bool connection_needs_attention: Indicates if this Transit Gateway has a
    ...
    :attr bool gre_enhanced_route_propagation: Allow route propagation across all
    ...
    :attr str redundancy_group: (optional) The redundancy group for this global
          transit gateway. The global transit gateways in this redundancy group will be
          redundant to each other.
    :attr str redundancy_group_id: (optional) The unique identifier of the
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitGateway':
        ...
        if 'redundancy_group' in _dict:
            args['redundancy_group'] = _dict.get('redundancy_group')
        if 'redundancy_group_id' in _dict:
            args['redundancy_group_id'] = _dict.get('redundancy_group_id')
...
class TransitGatewayTunnel:
    ...
    :attr int mtu: (optional) GRE tunnel MTU.
