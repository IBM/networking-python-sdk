...
class TransitGatewayApisV1(BaseService):
    ...
    def list_transit_gateways(
        ...
        **kwargs,
        ...
        List all Transit Gateways in the account the caller is authorized to view. Use the
        `limit` (integer, 1–100, default 50) and `start` (string token) parameters to page
        through results. Optionally filter by `redundancy_group` name. Each
        ...
        `redundancy_group_id`, `gre_enhanced_route_propagation`, and
        ...
        :param str redundancy_group: (optional) Filter the list of transit gateways
               by redundancy group name.
    ...
    def create_transit_gateway(
        ...
        **kwargs,
        ...
        Create a Transit Gateway based on the supplied input template. Required fields:
        `name` (string, 1–60 chars), `location` (IBM Cloud region, e.g. us-south).
        ...
        :param str redundancy_group: (optional) Include the global transit gateway
               in this redundancy group. When set, this transit gateway will be redundant
               to other transit gateways in this redundancy group. If this redundancy
    ...
    def delete_transit_gateway(
        ...
        **kwargs,
        ...
        Delete a Transit Gateway specified by its `id` path parameter. This operation
        cannot be reversed. The gateway must have no attached connections before it can be
        deleted; remove all connections first.
    ...
    def get_transit_gateway(
        ...
        **kwargs,
        ...
        Retrieve a single Transit Gateway specified by its `id` path parameter. Returns a
        `TransitGateway` object containing: `id`, `name`, `crn`, `location`,
        `status`, `global`, `created_at`, `updated_at`, `resource_group`, and optionally
        `redundancy_group`, `redundancy_group_id`, `gre_enhanced_route_propagation`, and
        `connection_needs_attention`.
    ...
    def update_transit_gateway(
        ...
        **kwargs,
        ...
        Update a Transit Gateway specified by its `id` path parameter. Updatable fields:
        `name` (string), `global` (boolean), `redundancy_group` (string, assigns the
        gateway to a redundancy group), `gre_enhanced_route_propagation` (boolean).
        Returns the updated `TransitGateway` object.

        :param str id: The Transit Gateway identifier.
        :param bool global_: (optional) Allow global routing for a Transit Gateway.
               This property cannot be changed if the transit gateway has redundancy_group
               set.
        :param bool gre_enhanced_route_propagation: (optional) Allow route
               propagation across all GREs connected to the same transit gateway. This
               affects connections on the gateway of type `redundant_gre`,
        ...
        :param str redundancy_group: (optional) Create a new redundancy group with
               this name and add the gateway to it. This property is only valid when the
               gateway is global (or `global` is set to `true` in the same request), the
               gateway is not already a member of a redundancy group, and no redundancy
               group with this name already exists in the account.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `TransitGateway` object
        """
    ...
    def list_connections(
        ...
        **kwargs,
        ...
        List all transit gateway connections associated with this account. Results can be
        filtered by `network_id` or `network_type`. Use the `limit` and `start` parameters
        to page through large result sets. The response includes a `TransitConnection`
        object for each connection, containing fields such as `id`, `name`,
        `network_type`,
        `status`, `created_at`, `updated_at`, and optionally `prefix_filters`,
        `request_status`, and `transit_gateway` reference.
        ...
        :param str network_id: (optional) Search for connections with the given
               network_id value.
        :param str network_type: (optional) Search for connections with the given
               network_type value.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def create_transit_gateway_connection(
        ...
        **kwargs,
        ...
        :param str base_network_type: (optional) The type of network the Unbound
               ...
               `directlink`, `vpc`, `power_virtual_server`, `vpn_gateway`,
               `dynamic_route_server` and `gre_tunnel` connections.
        :param str cidr: (optional) network_type `vpn_gateway` and
               `dynamic_route_server`connections use `cidr` to specify the CIDR to use for
               the VPN gateway / Dynamic route server GRE tunnels.
               This field is optional for network type `vpn_gateway` and
               `dynamic_route_server` connections. If unspecified, the default value is
               198.19.174.0/23.
               This field is required to be unspecified for network type `classic`,
               `directlink`, `vpc`, `power_virtual_server`, `gre_tunnel`,
        ...
        :param str local_gateway_ip: (optional) Local gateway IP address. This
               ...
               `classic`, `directlink`, `vpc`, `power_virtual_server`, `vpn_gateway`,
        ...
        :param str name: (optional) The user-defined name for this transit gateway
               ...
               `directlink`, `gre_tunnel`, `unbound_gre_tunnel`, `vpn_gateway`,
               `dynamic_route_server` and `redundant_gre` connections.
        ...
        :param str network_id: (optional) The ID of the network being connected via
               ...
               `dynamic_route_server`, `power_virtual_server` and `directlink` this is the
               CRN of the VPC / VPN / Dynamic Route Server / PowerVS / Direct Link gateway
               respectively. This field is required for network type `vpc`,
               `power_virtual_server`, `vpn_gateway`, `dynamic_route_server` and
        ...
        :param List[TransitGatewayConnectionPrefixFilter] prefix_filters:
               ...
               connections. This field is required to be unspecified for network type
               `gre_tunnel`, `unbound_gre_tunnel`, `vpn_gateway`, `dynamic_route_server`
        ...
        :param ZoneIdentity zone: (optional) Specify the connection's location.
               ...
               This field is required to be unspecified for network type `classic`,
               `directlink`, `vpc`, `power_virtual_server`, `redundant_gre` and
               `dynamic_route_server` connections.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def list_redundancy_groups(
        ...
        **kwargs,
        ...
        :param str name: (optional) Filter the list of redundancy groups by name.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `RedundancyGroupCollection` object
        """
        ...
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V1',
            operation_id='list_redundancy_groups',
        )
        headers.update(sdk_headers)
    ...
    def get_redundancy_group(
        ...
        **kwargs,
        ...
        :param str id: The redundancy group identifier.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `RedundancyGroup` object
        """
        ...
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V1',
            operation_id='get_redundancy_group',
        )
        headers.update(sdk_headers)
        ...
        path_param_values = self.encode_path_vars(id)
        path_param_dict = dict(zip(path_param_keys, path_param_values))
        url = '/redundancy_groups/{id}'.format(**path_param_dict)
        request = self.prepare_request(
            method='GET',
            url=url,
            headers=headers,
    ...
    def update_redundancy_group(
        self,
        id: str,
        redundancy_group_patch: 'RedundancyGroupPatch',
        **kwargs,
    ) -> DetailedResponse:
        """
        ...
        :param str id: The redundancy group identifier.
        :param RedundancyGroupPatch redundancy_group_patch: The redundancy group
               update template.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `RedundancyGroup` object
        ...
        if not id:
            raise ValueError('id must be provided')
        if redundancy_group_patch is None:
            raise ValueError('redundancy_group_patch must be provided')
        if isinstance(redundancy_group_patch, RedundancyGroupPatch):
            redundancy_group_patch = convert_model(redundancy_group_patch)
        headers = {}
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V1',
            operation_id='update_redundancy_group',
        )
        headers.update(sdk_headers)
        ...
        data = json.dumps(redundancy_group_patch)
        headers['content-type'] = 'application/merge-patch+json'
...
class PrefixFilterCollection:
    ...
    def from_dict(cls, _dict: Dict) -> 'PrefixFilterCollection':
        ...
        args = {}
        if (prefix_filters := _dict.get('prefix_filters')) is not None:
            args['prefix_filters'] = [PrefixFilterCust.from_dict(v) for v in prefix_filters]
        else:
...
class PrefixFilterCust:
    ...
    :param str action: Whether or not this prefix filter should allow or deny
          prefixes matching this filter's prefix definition.
    :param str before: (optional) A reference to the prefix filter that will be the
    ...
    :param datetime updated_at: (optional) The date and time that this prefix filter
          was last updated.
    """
...
class RedundancyGroup:
    ...
    :param datetime created_at: The date and time that this redundancy group was
          created.
    :param str id: The unique identifier for this redundancy group.
    :param str name: The redundancy group name.
    :param datetime updated_at: (optional) The date and time that this redundancy
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a RedundancyGroup object.

        :param datetime created_at: The date and time that this redundancy group
               was created.
        :param str id: The unique identifier for this redundancy group.
        :param str name: The redundancy group name.
        :param datetime updated_at: (optional) The date and time that this
               redundancy group was last updated.
        """
        self.created_at = created_at
        self.id = id
        self.name = name
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'RedundancyGroup':
        """Initialize a RedundancyGroup object from a json dictionary."""
        args = {}
        if (created_at := _dict.get('created_at')) is not None:
            args['created_at'] = string_to_datetime(created_at)
        else:
            raise ValueError('Required property \'created_at\' not present in RedundancyGroup JSON')
        if (id := _dict.get('id')) is not None:
            args['id'] = id
        else:
            raise ValueError('Required property \'id\' not present in RedundancyGroup JSON')
        if (name := _dict.get('name')) is not None:
            args['name'] = name
        else:
            raise ValueError('Required property \'name\' not present in RedundancyGroup JSON')
        if (updated_at := _dict.get('updated_at')) is not None:
            args['updated_at'] = string_to_datetime(updated_at)
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this RedundancyGroup object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'RedundancyGroup') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'RedundancyGroup') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other


class RedundancyGroupCollection:
    """
    A list of redundancy groups.

    :param List[RedundancyGroup] redundancy_groups: Collection of redundancy groups.
    """
    ...
    def __init__(
        ...
        """
        Initialize a RedundancyGroupCollection object.

        :param List[RedundancyGroup] redundancy_groups: Collection of redundancy
               groups.
        """
        self.redundancy_groups = redundancy_groups

    @classmethod
    def from_dict(cls, _dict: Dict) -> 'RedundancyGroupCollection':
        """Initialize a RedundancyGroupCollection object from a json dictionary."""
        args = {}
        if (redundancy_groups := _dict.get('redundancy_groups')) is not None:
            args['redundancy_groups'] = [RedundancyGroup.from_dict(v) for v in redundancy_groups]
        else:
            raise ValueError('Required property \'redundancy_groups\' not present in RedundancyGroupCollection JSON')
        return cls(**args)
    ...
    def to_dict(self) -> Dict:
        """Return a json dictionary representing this model."""
        _dict = {}
        if hasattr(self, 'redundancy_groups') and self.redundancy_groups is not None:
            redundancy_groups_list = []
            for v in self.redundancy_groups:
                if isinstance(v, dict):
                    redundancy_groups_list.append(v)
                else:
                    redundancy_groups_list.append(v.to_dict())
            _dict['redundancy_groups'] = redundancy_groups_list
        return _dict
    ...
    def __str__(self) -> str:
        """Return a `str` version of this RedundancyGroupCollection object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'RedundancyGroupCollection') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'RedundancyGroupCollection') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other


class RedundancyGroupPatch:
    """
    An update template for a redundancy group.

    :param str name: (optional) The new name for the redundancy group.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a RedundancyGroupPatch object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'RedundancyGroupPatch':
        """Initialize a RedundancyGroupPatch object from a json dictionary."""
        args = {}
        if (name := _dict.get('name')) is not None:
            args['name'] = name
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this RedundancyGroupPatch object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'RedundancyGroupPatch') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'RedundancyGroupPatch') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class RouteReport:
    ...
    :param List[RouteReportConnection] connections: Array of connections with their
          routes.
    ...
    def from_dict(cls, _dict: Dict) -> 'RouteReport':
        ...
        if (connections := _dict.get('connections')) is not None:
            args['connections'] = [RouteReportConnection.from_dict(v) for v in connections]
        else:
...
class RouteReportConnection:
    ...
    :param List[RouteReportConnectionBgp] bgps: Array of connection's bgps.
    :param str id: (optional) connection ID.
    :param str name: (optional) connection name.
    :param List[RouteReportConnectionRoute] routes: Array of connection's routes.
    :param str type: (optional) connection type.
    """

    def __init__(
        self,
        bgps: List['RouteReportConnectionBgp'],
        routes: List['RouteReportConnectionRoute'],
        *,
        ...
        :param List[RouteReportConnectionBgp] bgps: Array of connection's bgps.
        :param List[RouteReportConnectionRoute] routes: Array of connection's
               routes.
        :param str id: (optional) connection ID.
        :param str name: (optional) connection name.
        :param str type: (optional) connection type.
    ...
    def from_dict(cls, _dict: Dict) -> 'RouteReportConnection':
        ...
        args = {}
        if (bgps := _dict.get('bgps')) is not None:
            args['bgps'] = [RouteReportConnectionBgp.from_dict(v) for v in bgps]
        else:
            raise ValueError('Required property \'bgps\' not present in RouteReportConnection JSON')
        if (id := _dict.get('id')) is not None:
            args['id'] = id
        if (name := _dict.get('name')) is not None:
            args['name'] = name
        if (routes := _dict.get('routes')) is not None:
            args['routes'] = [RouteReportConnectionRoute.from_dict(v) for v in routes]
        else:
...
class RouteReportOverlappingRouteGroup:
    ...
    :param List[RouteReportOverlappingRoute] routes: Array of overlapping
          connection/prefix pairs.
    """

    def __init__(
        self,
        routes: List['RouteReportOverlappingRoute'],
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'RouteReportOverlappingRouteGroup':
        ...
        args = {}
        if (routes := _dict.get('routes')) is not None:
            args['routes'] = [RouteReportOverlappingRoute.from_dict(v) for v in routes]
        else:
            raise ValueError('Required property \'routes\' not present in RouteReportOverlappingRouteGroup JSON')
        return cls(**args)
...
class TSCollection:
    ...
    :param List[TSLocationBasic] locations: Collection of Transit Gateway locations.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'TSCollection':
        ...
        if (locations := _dict.get('locations')) is not None:
            args['locations'] = [TSLocationBasic.from_dict(v) for v in locations]
        else:
...
class TSLocalLocation:
    ...
    :param List[str] supported_connection_types: Array of supported connection
          types.
    ...
    def __init__(
        ...
        display_name: str,
        name: str,
        supported_connection_types: List[str],
        type: str,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TSLocalLocation':
        ...
        if (supported_connection_types := _dict.get('supported_connection_types')) is not None:
            args['supported_connection_types'] = supported_connection_types
        else:
            raise ValueError('Required property \'supported_connection_types\' not present in TSLocalLocation JSON')
        if (type := _dict.get('type')) is not None:
            args['type'] = type
        else:
...
class TSLocation:
    ...
    :param str billing_location: The geographical location of this location, used
    ...
    def from_dict(cls, _dict: Dict) -> 'TSLocation':
        ...
        if (local_connection_locations := _dict.get('local_connection_locations')) is not None:
            args['local_connection_locations'] = [TSLocalLocation.from_dict(v) for v in local_connection_locations]
        else:
...
class TransitConnection:
    ...
    :param str base_network_type: (optional) The type of network the GRE tunnel is
          targeting.
    ...
    :param str network_id: (optional) The ID of the network being connected via this
          ...
          `power_virtual_server`, `directlink`, `vpn_gateway`, `dynamic_route_server` and
          `redundant_gre`. For network types `vpc`, `vpn_gateway`, `dynamic_route_server`,
          `power_virtual_server` and `directlink` this is the CRN of the VPC / VPN /
          Dynamic Route Server / PowerVS / Direct Link gateway respectively.
    :param str network_type: Defines what type of network is connected via this
    ...
    :param str base_connection_id: (optional) Deprecated: network_type `gre_tunnel`
    ...
    :param str cidr: (optional) network_type `vpn_gateway` and
          `dynamic_route_server` connections use `cidr` to specify the CIDR to use for the
    ...
    :param str local_gateway_ip: (optional) Local gateway IP address.  This field
          only applies to network type `gre_tunnel` and `unbound_gre_tunnel` connections.
    :param str local_tunnel_ip: (optional) Local tunnel IP address.  This field only
          applies to network type `gre_tunnel` and `unbound_gre_tunnel` connections.
    :param int mtu: (optional) GRE tunnel MTU.  This field only applies to network
          type `gre_tunnel` and `unbound_gre_tunnel` connections.
    :param str network_account_id: (optional) The ID of the account which owns the
    ...
    :param str remote_gateway_ip: (optional) Remote gateway IP address.  This field
          only applies to network type `gre_tunnel` and `unbound_gre_tunnel` connections.
    :param str remote_tunnel_ip: (optional) Remote tunnel IP address.  This field
          only applies to network type `gre_tunnel` and `unbound_gre_tunnel` connections.
    :param str request_status: Only visible for cross account connections, this
          field represents the status of a connection request between IBM Cloud accounts.
    ...
    :param List[TransitGatewayTunnel] tunnels: (optional) Collection of all tunnels
          for `redundant_gre`, `vpn_gateway` and `dynamic_route_server` connections.
    ...
    def __init__(
        ...
        *,
        ...
        network_account_id: Optional[str] = None,
        prefix_filters: Optional[List['TransitGatewayConnectionPrefixFilterReference']] = None,
        prefix_filters_default: Optional[str] = None,
        remote_bgp_asn: Optional[int] = None,
        remote_gateway_ip: Optional[str] = None,
        remote_tunnel_ip: Optional[str] = None,
        tunnels: Optional[List['TransitGatewayTunnel']] = None,
        ...
        :param str network_id: (optional) The ID of the network being connected via
               ...
               `power_virtual_server`, `directlink`, `vpn_gateway`, `dynamic_route_server`
               and `redundant_gre`. For network types `vpc`, `vpn_gateway`,
               `dynamic_route_server`, `power_virtual_server` and `directlink` this is the
               CRN of the VPC / VPN / Dynamic Route Server / PowerVS / Direct Link gateway
               respectively.
        :param str base_connection_id: (optional) Deprecated: network_type
        ...
        :param str cidr: (optional) network_type `vpn_gateway` and
               `dynamic_route_server` connections use `cidr` to specify the CIDR to use
               for the `VPN gateway / Dynamic route server` GRE tunnels.
        ...
        :param List[TransitGatewayTunnel] tunnels: (optional) Collection of all
               tunnels for `redundant_gre`, `vpn_gateway` and `dynamic_route_server`
               connections.
        :param ZoneReference zone: (optional) Availability zone reference.
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitConnection':
        ...
        args = {}
        if (base_network_type := _dict.get('base_network_type')) is not None:
            args['base_network_type'] = base_network_type
        if (name := _dict.get('name')) is not None:
            args['name'] = name
        else:
        ...
        if (network_type := _dict.get('network_type')) is not None:
        ...
        if (base_connection_id := _dict.get('base_connection_id')) is not None:
            args['base_connection_id'] = base_connection_id
        ...
        if (local_bgp_asn := _dict.get('local_bgp_asn')) is not None:
            args['local_bgp_asn'] = local_bgp_asn
        if (local_gateway_ip := _dict.get('local_gateway_ip')) is not None:
            args['local_gateway_ip'] = local_gateway_ip
        if (local_tunnel_ip := _dict.get('local_tunnel_ip')) is not None:
        ...
        if (prefix_filters := _dict.get('prefix_filters')) is not None:
            args['prefix_filters'] = [TransitGatewayConnectionPrefixFilterReference.from_dict(v) for v in prefix_filters]
        if (prefix_filters_default := _dict.get('prefix_filters_default')) is not None:
            args['prefix_filters_default'] = prefix_filters_default
        ...
        if (remote_gateway_ip := _dict.get('remote_gateway_ip')) is not None:
            args['remote_gateway_ip'] = remote_gateway_ip
        if (remote_tunnel_ip := _dict.get('remote_tunnel_ip')) is not None:
            args['remote_tunnel_ip'] = remote_tunnel_ip
        if (request_status := _dict.get('request_status')) is not None:
            args['request_status'] = request_status
        else:
        ...
        if (transit_gateway := _dict.get('transit_gateway')) is not None:
            args['transit_gateway'] = TransitGatewayReference.from_dict(transit_gateway)
        else:
        ...
        if (tunnels := _dict.get('tunnels')) is not None:
            args['tunnels'] = [TransitGatewayTunnel.from_dict(v) for v in tunnels]
        if (updated_at := _dict.get('updated_at')) is not None:
            args['updated_at'] = string_to_datetime(updated_at)
        else:
...
class TransitConnectionCollection:
    ...
    :param PaginationFirstConnection first: A reference to the first page of
          resources.
    :param int limit: The maximum number of connections returned on one request.
    :param PaginationNextConnection next: (optional) A reference to the next page of
    ...
    def __init__(
        ...
        limit: int,
        *,
        next: Optional['PaginationNextConnection'] = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitConnectionCollection':
        ...
        args = {}
        if (connections := _dict.get('connections')) is not None:
            args['connections'] = [TransitConnection.from_dict(v) for v in connections]
        else:
        ...
        if (first := _dict.get('first')) is not None:
            args['first'] = PaginationFirstConnection.from_dict(first)
        else:
        ...
        if (next := _dict.get('next')) is not None:
            args['next'] = PaginationNextConnection.from_dict(next)
        return cls(**args)
...
class TransitGateway:
    ...
    :param str location: Location of Transit Gateway Services.
    :param str name: A human readable name for the transit gateway.
    :param str redundancy_group: (optional) The redundancy group for this global
          transit gateway. The global transit gateways in this redundancy group will be
          redundant to each other.
    :param str redundancy_group_id: (optional) The unique identifier of the
          redundancy group for this global transit gateway.
    :param ResourceGroupReference resource_group: (optional) The resource group to
          ...
          used.
    :param str status: The status of the Transit Gateway. The list of enumerated
          values for this property may expand in the future. Code and processes using this
          field must tolerate unexpected values.
    :param datetime updated_at: (optional) The date and time that this gateway was
          last updated.
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param str crn: (optional) Cloud Resource Name of a transit gateway.
        :param str redundancy_group: (optional) The redundancy group for this
               global transit gateway. The global transit gateways in this redundancy
               group will be redundant to each other.
        :param str redundancy_group_id: (optional) The unique identifier of the
               redundancy group for this global transit gateway.
        ...
        self.gre_enhanced_route_propagation = gre_enhanced_route_propagation
        self.id = id
        self.location = location
        self.name = name
        self.redundancy_group = redundancy_group
        self.redundancy_group_id = redundancy_group_id
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitGateway':
        ...
        if (redundancy_group := _dict.get('redundancy_group')) is not None:
            args['redundancy_group'] = redundancy_group
        if (redundancy_group_id := _dict.get('redundancy_group_id')) is not None:
            args['redundancy_group_id'] = redundancy_group_id
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'gre_enhanced_route_propagation') and self.gre_enhanced_route_propagation is not None:
            _dict['gre_enhanced_route_propagation'] = self.gre_enhanced_route_propagation
        if hasattr(self, 'id') and self.id is not None:
            _dict['id'] = self.id
        ...
        if hasattr(self, 'name') and self.name is not None:
            _dict['name'] = self.name
        if hasattr(self, 'redundancy_group') and self.redundancy_group is not None:
            _dict['redundancy_group'] = self.redundancy_group
        if hasattr(self, 'redundancy_group_id') and self.redundancy_group_id is not None:
            _dict['redundancy_group_id'] = self.redundancy_group_id
...
class TransitGatewayCollection:
    ...
    :param PaginationNextTG next: (optional) A reference to the next page of
          resources; this reference is included for all pages except the last page.
    :param List[TransitGateway] transit_gateways: Collection of Transit Services
          gateways.
    """
    ...
    def __init__(
        ...
        *,
        next: Optional['PaginationNextTG'] = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitGatewayCollection':
        ...
        args = {}
        if (first := _dict.get('first')) is not None:
            args['first'] = PaginationFirstTG.from_dict(first)
        else:
        ...
        if (next := _dict.get('next')) is not None:
            args['next'] = PaginationNextTG.from_dict(next)
        if (transit_gateways := _dict.get('transit_gateways')) is not None:
            args['transit_gateways'] = [TransitGateway.from_dict(v) for v in transit_gateways]
        else:
...
class TransitGatewayConnectionCollection:
    ...
    :param List[TransitGatewayConnectionCust] connections: Array of transit gateways
          network Connections.
    ...
    :param int limit: The maximum number of connections returned on one request.
          This will be returned when number of connections in response are greater than
          max page limit.
    :param PaginationNextTGWConnection next: (optional) A reference to the next page
          of resources; this reference is included for all pages except the last page.
    :param int total_count: total number of resources across all pages (considering
    ...
    def __init__(
        ...
        total_count: int,
        *,
        next: Optional['PaginationNextTGWConnection'] = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitGatewayConnectionCollection':
        ...
        args = {}
        if (connections := _dict.get('connections')) is not None:
            args['connections'] = [TransitGatewayConnectionCust.from_dict(v) for v in connections]
        else:
            raise ValueError('Required property \'connections\' not present in TransitGatewayConnectionCollection JSON')
        if (first := _dict.get('first')) is not None:
            args['first'] = PaginationFirstTGWConnection.from_dict(first)
        else:
        ...
        if (next := _dict.get('next')) is not None:
            args['next'] = PaginationNextTGWConnection.from_dict(next)
...
class TransitGatewayConnectionCust:
    ...
    :param str base_connection_id: (optional) Deprecated: network_type `gre_tunnel`
          ...
          deleted. This field only applies to and is required for network type
          `gre_tunnel` connections.
    :param str base_network_type: (optional) The type of network the Unbound GRE
          ...
          `power_virtual_server`, `vpn_gateway`, `dynamic_route_server` and `gre_tunnel`
          connections.
    :param str cidr: (optional) network_type `vpn_gateway` and
          `dynamic_route_server` connections use `cidr` to specify the CIDR to use for the
          `VPN gateway / Dynamic route server` GRE tunnels.
    ...
    :param str name: (optional) The user-defined name for this transit gateway
          ...
          `gre_tunnel`, `unbound_gre_tunnel`, `vpn_gateway`, `dynamic_route_server` and
          `redundant_gre` connections.
          This field is optional for network type `classic`, `vpc` connections.
    :param str network_account_id: (optional) The ID of the account which owns the
          connected network. Generally only used if the network is in a different IBM
          Cloud account than the gateway.
    :param str network_id: (optional) The ID of the network being connected via this
          connection. For network types `vpc`, `vpn_gateway`, `dynamic_route_server`,
          `power_virtual_server` and `directlink` this is the CRN of the VPC / VPN /
          Dynamic Route Server / PowerVS / Direct Link gateway respectively. This field is
          required for network type `vpc`, `power_virtual_server`, `vpn_gateway`,
          `dynamic_route_server` and `directlink` connections.  It is also required for
          `redundant_gre` connections when the base_network_type is set to VPC. This field
          is required to be unspecified for network type `classic`, `gre_tunnel` and
          `unbound_gre_tunnel` connections.
    :param str network_type: (optional) Defines what type of network is connected
          via this connection.
    :param List[TransitGatewayConnectionPrefixFilterReference] prefix_filters:
          (optional) Array of prefix route filters for a transit gateway connection. This
          is order dependent with those first in the array being applied first, and those
    ...
    class BaseNetworkTypeEnum(str, Enum):
        ...
        `directlink`, `vpc`, `power_virtual_server`, `vpn_gateway`, `dynamic_route_server`
...
class TransitGatewayTunnel:
    ...
    :param str base_network_type: The type of network the redundant GRE tunnel is
          targeting.
    :param datetime created_at: The date and time that this GRE tunnel was created.
    :param str id: The unique identifier for this redundant GRE tunnel.
    :param int local_bgp_asn: Local network BGP ASN.  It is assigned by IBM when the
          tunnel is created.
    :param str local_gateway_ip: Local gateway IP address.
    ...
    :param str status: Tunnel's current configuration state. The list of enumerated
          values for this property may expand in the future. Code and processes using this
          field must tolerate unexpected values.
    :param datetime updated_at: The date and time that this tunnel was last updated.
...
class TransitGatewayTunnelCollection:
    """
    Collection of all tunnels for `redundant_gre`, `vpn_gateway` and
    `dynamic_route_server` connections.

    :param List[TransitGatewayTunnel] tunnels: Collection of all tunnels for
          `redundant_gre`, `vpn_gateway` and `dynamic_route_server` connections.
    """
...
class TransitGatewayTunnelPatch:
    ...
    :param str name: (optional) The user-defined name for this connection tunnel.
    """
...
class TransitGatewaysPager:
    ...
    def __init__(
        ...
        *,
        ...
        self._limit = limit
        self._redundancy_group = redundancy_group
    ...
    def get_next(self) -> List[dict]:
        ...
        result = self._client.list_transit_gateways(
            limit=self._limit,
            redundancy_group=self._redundancy_group,
