    ...
    def create_transit_gateway_connection(
        ...
        **kwargs,
        ...
        :param str network_id: (optional) The ID of the network being connected via
               this connection. For network types `vpc`,`power_virtual_server`,
               ...
               type `vpc`, `power_virtual_server`, `vpn_gateway`, and `directlink`
...
class RouteReportConnection:
    ...
    :param List[RouteReportConnectionBgp] bgps: (optional) Array of connection's
          bgps.
    :param str id: (optional) connection ID.
    :param str name: (optional) connection name.
    :param List[RouteReportConnectionRoute] routes: (optional) Array of connection's
          routes.
    ...
    def __init__(
        self,
        *,
        bgps: Optional[List['RouteReportConnectionBgp']] = None,
        id: Optional[str] = None,
        name: Optional[str] = None,
        routes: Optional[List['RouteReportConnectionRoute']] = None,
...
class TSLocalLocation:
    ...
    def __init__(
        ...
        type: str,
        *,
        supported_connection_types: Optional[List[str]] = None,
    ) -> None:
        """
...
class TransitConnection:
    ...
    :param str network_id: (optional) The ID of the network being connected via this
          ...
          network types `vpc`, `redundant_gre`, `power_virtual_server` and `directlink`
          this is the CRN of the VPC  / PowerVS / VDC / Direct Link gateway respectively.
    :param str network_type: Defines what type of network is connected via this
    ...
    def __init__(
        ...
        *,
        ...
        :param str network_id: (optional) The ID of the network being connected via
               ...
               For network types `vpc`, `redundant_gre`, `power_virtual_server` and
               `directlink` this is the CRN of the VPC  / PowerVS / VDC / Direct Link
...
class TransitGatewayConnectionCust:
    ...
    :param str network_account_id: (optional) The ID of the account which owns the
          ...
          Cloud account than the gateway.
    :param str network_id: (optional) The ID of the network being connected via this
          connection. For network types `vpc`,`power_virtual_server`, `directlink` and
          `vpn_gateway` this is the CRN of the VPC / PowerVS / VDC / Direct Link / VPN
          gateway respectively. This field is required for network type `vpc`,
