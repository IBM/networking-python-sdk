...
class TransitGatewayApiV1(BaseService):
    """The Transit Gateway API V1 service."""

    DEFAULT_SERVICE_URL = 'https://transit.cloud.ibm.com/v1'
    DEFAULT_SERVICE_NAME = 'transit_gateway_api'
    ...
    def new_instance(
        ...
        """
        Return a new client for the Transit Gateway API service using the specified
    ...
    def __init__(
        ...
        """
        Construct a new client for the Transit Gateway API service.
...
class RouteReportConnectionBgp:
    ...
    :param bool is_used: (optional) Indicates whether current route is used or not.
...
class TransitGatewayConnectionCust:
    ...
    :param datetime updated_at: The date and time that this connection was last
          updated.
    :param TransitGatewayConnectionCustZone zone: (optional) Location of GRE tunnel.
    ...
    def __init__(
        ...
        *,
        ...
        remote_tunnel_ip: Optional[str] = None,
        tunnels: Optional[List['TransitGatewayTunnel']] = None,
        zone: Optional['TransitGatewayConnectionCustZone'] = None,
    ) -> None:
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TransitGatewayConnectionCust':
        ...
        if (zone := _dict.get('zone')) is not None:
            args['zone'] = TransitGatewayConnectionCustZone.from_dict(zone)
        return cls(**args)
