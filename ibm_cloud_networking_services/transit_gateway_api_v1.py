...
class TransitGatewayApiV1(BaseService):
    ...
    def create_transit_gateway(
        ...
        **kwargs,
        ...
        :param str location: (optional) Location of Transit Gateway Services.
        :param str name: (optional) A human readable name for the transit gateway.
    ...
    def create_transit_gateway_connection(
        ...
        **kwargs,
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `TransitGatewayConnection` object
        """
